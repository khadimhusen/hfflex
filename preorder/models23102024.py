...
class JobName(models.Model):
    ...
    new_cyl_qty=models.PositiveSmallIntegerField(blank=True,null=True)
    cyl_invoice=models.CharField(max_length=32, blank=True,null=True)
    cyl_cost=models.DecimalField(max_digits=7, decimal_places=2,blank=True,null=True)
    design_charges=models.DecimalField(max_digits=7,decimal_places=2,blank=True,null=True)
