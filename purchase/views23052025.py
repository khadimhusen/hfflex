...
from .forms import PoForm, PoItemForm, PoApprovalForm, PoImageForm, PoItemFormMarketing
...
def purchaselist(request):
    ...
    if request.user.username in ["khadimhusen", "firoj", "admin", "ashraf", "sachin", "wasim", "vasim", "zaid","bhagyshree"]:
...
def purchaseedit(request, id=None):
    ...
    if request.user.username in ["khadimhusen", "firoj", "admin", "zaid", "ashraf"]:
        can_add_price = True
...
def deepclonepurchase(request, id=None):
    ...
    if request.user.username in ["khadimhusen", "firoj", "admin"]:
        can_add_price = True
