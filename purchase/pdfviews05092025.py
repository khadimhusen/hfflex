...
def popdf(request, id):
    ...
    p.drawRightString(A4[0] - 140, A4[1] - 50, 'Expected Delivery:- ')
...
def newpopdf(request, id):
    ...
    def pageheader():
        ...
        p.drawRightString(A4[0] - 170, A4[1] - 50, 'Expected Delivery:- ')
        p.drawString(A4[0] - 170, A4[1] - 50, purchase.delivery_date.strftime("%d/%m/%Y"))
        p.drawRightString(A4[0] - 170, A4[1] - 65, 'Transportation:- ')
