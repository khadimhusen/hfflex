...
class ItemMaster(models.Model):
    ...
    unwind_direction = models.CharField(max_length=32, choices=DIRECTION, default="READABLE")
...
class ItemStandardParameter(models.Model):
    ...
    def __str__(self):
        return str(self.itemmaster)[0:20] + " : " + self.value + " : " + str(self.standard_parameter) +"  " +str(self.value)
